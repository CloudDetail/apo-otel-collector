...
func Meter(settings component.TelemetrySettings) metric.Meter {
	return settings.MeterProvider.Meter("github.com/CloudDetail/apo-otel-collector/pkg/processor/backsamplingprocessor")
}

func Tracer(settings component.TelemetrySettings) trace.Tracer {
	return settings.TracerProvider.Tracer("github.com/CloudDetail/apo-otel-collector/pkg/processor/backsamplingprocessor")
}
...
type TelemetryBuilder struct {
	meter                            metric.Meter
	ProcessorBackSamplingSampleValue metric.Int64Gauge
	ProcessorBackSamplingSpanCount   metric.Int64Counter
