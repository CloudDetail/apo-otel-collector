...
require (
	...
	github.com/CloudDetail/apo-otel-collector/pkg/extension/tenantextension v0.0.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/exporter/clickhouseexporter => ./pkg/exporter/clickhouseexporter

replace github.com/CloudDetail/apo-otel-collector/pkg/extension/tenantextension => ./pkg/extension/tenantextension
